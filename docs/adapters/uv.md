...
`x86_64` and `arm64`. It reads uv's own system, user, and project configuration; pip configuration
is never treated as a complete uv model. User scope is the automatic default, while project scope
