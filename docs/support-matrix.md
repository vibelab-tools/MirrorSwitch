...
| Node distributions | [nvm #49](https://github.com/vibelab-tools/MirrorSwitch/issues/49), [fnm #50](https://github.com/vibelab-tools/MirrorSwitch/issues/50) | One explicitly selected user shell environment | separate Node.js/io.js indexes, target checksum and `x64`/`arm64` assets; no npm Registry substitution or silent official fallback | nvm Supported; fnm Planned |
