...
| CI tooling | [Jenkins #83](https://github.com/vibelab-tools/MirrorSwitch/issues/83), [GitLab Runner #93](https://github.com/vibelab-tools/MirrorSwitch/issues/93) | System; service restart never implicit | GitLab Runner 19.x APT/RPM amd64/arm64 with separate metadata/package keys; runner registration, executor and GitLab server config preserved | GitLab Runner Supported; Jenkins Planned |
...
of Technology alongside the original candidates.
