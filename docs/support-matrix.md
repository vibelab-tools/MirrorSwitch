...
| Observability/search | [Elastic Stack #90](https://github.com/vibelab-tools/MirrorSwitch/issues/90), [Grafana #91](https://github.com/vibelab-tools/MirrorSwitch/issues/91), [Zabbix #92](https://github.com/vibelab-tools/MirrorSwitch/issues/92) | System / elevated apply | Elastic Stack 9.x stable: APT amd64 and RPM x86_64/aarch64, with Elasticsearch/Kibana/Logstash/Filebeat artifacts independently verified; no service action | Elastic Stack Supported; Grafana/Zabbix Planned |
