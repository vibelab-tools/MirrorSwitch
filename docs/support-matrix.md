...
| --- | --- | --- | --- | --- | --- | --- |
| APT | [#27](https://github.com/vibelab-tools/MirrorSwitch/issues/27) | Installed and supported Debian-family OS | System / elevated apply | `.list`, deb822 `.sources`, keyrings | `apt-get update` and effective source parse | Supported |
| DNF | [#28](https://github.com/vibelab-tools/MirrorSwitch/issues/28) | Installed DNF/DNF5 | System / elevated apply | `.repo`, variables, metalink/mirrorlist/baseurl | metadata refresh/query | Supported |
| YUM | [#29](https://github.com/vibelab-tools/MirrorSwitch/issues/29) | Real YUM environment, not a duplicate DNF alias | System / elevated apply | `.repo`, releasever/basearch, Vault rules | metadata refresh/query | Supported |
| Pacman | [#30](https://github.com/vibelab-tools/MirrorSwitch/issues/30) | Installed on a supported Arch-family upstream | System / elevated apply | `pacman.conf`, Include, mirrorlist | database refresh/query | Supported |
| Zypper | [#31](https://github.com/vibelab-tools/MirrorSwitch/issues/31) | Installed on supported SUSE-family OS | System / elevated apply | repository definitions, priority, refresh | repository refresh/query | Supported |
| APK | [#33](https://github.com/vibelab-tools/MirrorSwitch/issues/33) | Installed on Alpine | System / elevated apply | `/etc/apk/repositories` | index refresh/query | Supported |
| Portage/emerge | [#32](https://github.com/vibelab-tools/MirrorSwitch/issues/32) | Installed; extended scope | System / elevated apply | `GENTOO_MIRRORS`, repos.conf | emerge/emaint query | Supported |
| XBPS | [#34](https://github.com/vibelab-tools/MirrorSwitch/issues/34) | Installed; extended scope | System / elevated apply | repository config | index refresh/query | Supported |
| Nix | [#35](https://github.com/vibelab-tools/MirrorSwitch/issues/35) | Installed; extended scope | User or daemon-specific | substituters, trusted keys, channels/flakes | effective config and real query | Supported |
...
| Python distributions | [Conda/Mamba #42](https://github.com/vibelab-tools/MirrorSwitch/issues/42), [pyenv #69](https://github.com/vibelab-tools/MirrorSwitch/issues/69) | User | channel/subdir/architecture or exact source release and checksum | Supported |
...
| Perl | [CPAN clients #67](https://github.com/vibelab-tools/MirrorSwitch/issues/67) | User | client-specific config, indexes, distributions and checksum | Supported |
| R | [CRAN #68](https://github.com/vibelab-tools/MirrorSwitch/issues/68), [Bioconductor #64](https://github.com/vibelab-tools/MirrorSwitch/issues/64) | User; project off | R/Bioconductor version pairing, all required repository classes | Supported |
| TeX | [tlmgr/CTAN #65](https://github.com/vibelab-tools/MirrorSwitch/issues/65) | User/system install-specific | TeX Live release year, tlpkg metadata, platform assets | Supported |
| Dart/Flutter | [Dart Pub #63](https://github.com/vibelab-tools/MirrorSwitch/issues/63), [Flutter #66](https://github.com/vibelab-tools/MirrorSwitch/issues/66) | User | registry vs SDK/engine artifacts, channel/version/architecture | Supported |
...
| OCaml | [opam #71](https://github.com/vibelab-tools/MirrorSwitch/issues/71) | User; project off | repository protocol vs archive cache | Supported |
...
| Robotics | [ROS 1 #81](https://github.com/vibelab-tools/MirrorSwitch/issues/81), [ROS 2 #84](https://github.com/vibelab-tools/MirrorSwitch/issues/84) | System / elevated apply | ROS 1 final Noetic/Focal snapshot; ROS 2 Humble/Jazzy/Kilted/Lyrical matched to Ubuntu or RHEL release, signed APT/RPM metadata, exact architecture package and native package-manager query; RPM arm64 is explicitly unsupported upstream | Supported |
| CI tooling | [Jenkins #83](https://github.com/vibelab-tools/MirrorSwitch/issues/83), [GitLab Runner #93](https://github.com/vibelab-tools/MirrorSwitch/issues/93) | System; Jenkins explicit-only; service restart never implicit | Jenkins 2.581 immutable JSONP signature/certificate/HPI chain with private sites preserved; GitLab Runner 19.x signed APT/RPM amd64/arm64 package repositories | Supported |
...
| Observability/search | [Elastic Stack #90](https://github.com/vibelab-tools/MirrorSwitch/issues/90), [Grafana #91](https://github.com/vibelab-tools/MirrorSwitch/issues/91), [Zabbix #92](https://github.com/vibelab-tools/MirrorSwitch/issues/92) | System / elevated apply | Elastic Stack 9.x, Grafana OSS/Enterprise 13.x stable, Zabbix 7.4 stable; exact APT/RPM architecture coverage, product artifacts, release packages and signatures verified; no service action | Supported |
| Server/storage packages | [Nginx #95](https://github.com/vibelab-tools/MirrorSwitch/issues/95), [Ceph #94](https://github.com/vibelab-tools/MirrorSwitch/issues/94) | System / elevated apply | Ceph Squid 19.x plus Nginx stable 1.30/mainline 1.31; exact Debian/Ubuntu/EL9 and amd64/arm64 signed package coverage; no service/data mutation | Supported |
...
separate provenance records. Docker daemon support adds DaoCloud and 1Panel; ROS 2 adds Qilu
University of Technology, Zhejiang University, Xi'an Jiaotong University, and Nanyang Institute
of Technology alongside the original candidates. Jenkins uses the separately recorded lework
signed-metadata provider only after explicit user selection.
