...
| Ruby | [RubyGems #52](https://github.com/vibelab-tools/MirrorSwitch/issues/52), [Bundler #58](https://github.com/vibelab-tools/MirrorSwitch/issues/58) | RubyGems: user; project off | ordered private/public source identity, classic index + gemspec dependency metadata, SHA-256 checked gem download, real client query; Bundler kept separate | RubyGems Supported; Bundler Planned |
...
| Haskell | [Cabal #57](https://github.com/vibelab-tools/MirrorSwitch/issues/57), [Stack #59](https://github.com/vibelab-tools/MirrorSwitch/issues/59), [GHCup #60](https://github.com/vibelab-tools/MirrorSwitch/issues/60) | Cabal: user; project configs read-only; Stack/GHCup separate | Cabal preserves repository identity and private/active-repository policy, checks signed Hackage metadata, index and SHA-256 pinned source tarball, then runs real update/info/get; Stackage and toolchain assets remain separate | Cabal Supported; Stack/GHCup Planned |
