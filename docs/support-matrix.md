...
| Haskell | [Cabal #57](https://github.com/vibelab-tools/MirrorSwitch/issues/57), [Stack #59](https://github.com/vibelab-tools/MirrorSwitch/issues/59), [GHCup #60](https://github.com/vibelab-tools/MirrorSwitch/issues/60) | Cabal: user; project configs read-only. Stack: user by default; project scope explicit. GHCup separate | Cabal preserves repository identity and private/active-repository policy. Stack independently selects Stackage snapshot/global-hints/setup and secure Hackage, preserves resolver/private/security policy, gates the host-architecture GHC bindist, and runs real fixed-snapshot dependency and package resolution | Cabal/Stack Supported; GHCup Planned |
