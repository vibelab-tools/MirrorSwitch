...
| Rust | [Cargo #53](https://github.com/vibelab-tools/MirrorSwitch/issues/53), [rustup #54](https://github.com/vibelab-tools/MirrorSwitch/issues/54) | User | Cargo sparse index, index checksum, and crate archive kept distinct; incomplete git-index mirrors are inert; toolchain manifests/components/targets remain separate | Cargo Supported; rustup Planned |
