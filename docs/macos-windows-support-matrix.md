...
| Yarn, fnm | Planned on x86_64/arm64 | Planned on x64/arm64 | User; project explicit | Registry metadata/tarball or Node release asset must match client generation and architecture. |
