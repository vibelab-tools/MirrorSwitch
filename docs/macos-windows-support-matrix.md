...
| tlmgr, ELPA | Planned on x86_64/arm64 | Planned on supported native architectures | User or install-specific system | Client-specific config, platform packages and native batch/query commands are required. |
