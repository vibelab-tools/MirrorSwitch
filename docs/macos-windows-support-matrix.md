...
| Composer | Planned on x86_64/arm64 | Planned on x64/arm64 | User; project explicit | Preserve auth/private sources and validate through native executable conventions. |
