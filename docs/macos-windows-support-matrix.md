...
| GHCup, Cabal, Stack | Planned where upstream tool supports the native OS | Planned where upstream tool supports the native OS | User; project explicit | Toolchain/platform bindists must pass separately from package indexes. |
