...
| Cabal, Stack | Planned where upstream tool supports the native OS | Planned where upstream tool supports the native OS | User; project explicit | Package indexes, snapshots and toolchain assets must pass independently ([#134](https://github.com/vibelab-tools/MirrorSwitch/issues/134), [#135](https://github.com/vibelab-tools/MirrorSwitch/issues/135)). |
