...
| Poetry, Conda | Planned on x86_64/arm64 | Planned on x64/arm64 | User; project/site explicit | PyPI/Conda metadata and platform subdirs; client precedence and virtual environment paths are native. |
