...
| pyenv | Planned for macOS only | Unix adapter not applicable | One user shell environment | pyenv-win is a different tool and has no validated six-provider source. |
