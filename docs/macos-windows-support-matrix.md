...
| Stack | Planned where upstream tool supports the native OS | Planned where upstream tool supports the native OS | User; project explicit | Snapshot, package index and toolchain assets must pass independently ([#135](https://github.com/vibelab-tools/MirrorSwitch/issues/135)). |
